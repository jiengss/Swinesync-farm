...
function App() {
  ...
  function showNotifToast(notif) {
    ...
    const icons = { pig_added: '🐷', feed_logged: '🌾', low_stock: '⚠️', growth_recorded: '📏', mortality_recorded: '💀', health_recorded: '💉', health_treatment: '🩺', vaccination_due: '📅', vaccination_overdue: '🚨', missed_feeding: '🍽️' }
    const icon = icons[notif.type] || '🔔'
    const titles = { pig_added: 'New Pig Added', feed_logged: 'Feed Logged', low_stock: 'Low Stock Alert', growth_recorded: 'Growth Recorded', mortality_recorded: 'Mortality Reported', health_recorded: 'Health Record Added', health_treatment: 'Treatment Applied', vaccination_due: 'Vaccination Due', vaccination_overdue: 'Vaccination Overdue', missed_feeding: 'Missed Feeding' }
    const title = titles[notif.type] || 'Notification'
    toast.innerHTML = `
