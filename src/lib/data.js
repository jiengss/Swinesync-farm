  ...
  return {
    ...
    async insert(record) {
      ...
      try {
        ...
        console.warn(`Online insert failed for ${tableName}, falling back to local:`, err);
        return saveOffline();
      }
    },
    ...
    async update(id, updates) {
      ...
      try {
        ...
        console.warn(`Online update failed for ${tableName}, falling back to local:`, err);
        return saveOffline();
      }
    },
    ...
    async delete(id) {
      ...
      try {
        ...
        console.warn(`Online delete failed for ${tableName}, falling back to local:`, err);
        return saveOffline();
      }
    },
  };
