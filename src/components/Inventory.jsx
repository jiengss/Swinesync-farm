      ...
      <div className="card" style={{ marginBottom: 24 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12, marginBottom: 20 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <span style={{ fontSize: 13, color: online ? '#10b981' : '#ef4444', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 6 }}>
              <i className={`fas fa-${online ? 'wifi' : 'wifi-slash'}`} />
              {online ? 'Online' : 'Offline'}
            </span>
            <button onClick={handleSync} disabled={syncing} style={{
              background: '#10b981', color: 'white', border: 'none', borderRadius: 999,
              padding: '7px 16px', cursor: syncing ? 'not-allowed' : 'pointer',
              fontSize: 13, display: 'flex', alignItems: 'center', gap: 6,
              opacity: syncing ? 0.7 : 1, fontWeight: 600,
            }}>
